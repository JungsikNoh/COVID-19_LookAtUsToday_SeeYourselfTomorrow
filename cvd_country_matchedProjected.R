...
cvd_country_matchedProjected = function(curDate, stname, jhudat, countryNamePop){
  #
  ...
  #stInd = which(state.abb == stname)
  #stfullname = state.name[stInd]
  ...
  # KO, IT
  B1 = datf3_prj2[, 13:14]
  B2 = rbind(rep(NA, 2), B1[1:(XprjLongestLen - 1),])
  B3 = B1 - B2
  B4 = (B3 / B2) * 100
  ...
  #
  outPath2 = file.path(getwd(), 'output', 'countries_uptodate')  
  ...
  result = list(cntrName = stname, myCaptn1=myCaptn1, myCaptn2=myCaptn2, 
